<x-app-layout>
    ...
    <form method="POST" action="{{ route('meditation-type.update', $meditationType->id) }}"
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <!-- thumb_image -->
            <div class="mt-4">
                <x-input-label for="thumb_image" :value="__('Thumb Image (200x200)')" />
            ...
            <div class="mt-4">
                ...
                <textarea id="short_description" name="short_description" rows="4"
                    ...
                    placeholder="Enter short description...">{{ old('short_description', $meditationType->short_description) }}</textarea>
            ...
            <div class="mt-4">
                ...
                <textarea id="description" name="description" rows="4"
                    class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                    placeholder="Enter description...">{{ old('description', $meditationType->description) }}</textarea>
