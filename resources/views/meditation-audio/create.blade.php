...
<div class="mt-4">
    ...
    <!-- 👇 Preview Image -->
    <img id="audio_thumb_preview" src="#" class="w-16 my-2 hidden" alt="Audio Thumb Preview" />
</div>
...
<div class="mt-4">
    ...
    <!-- 👇 Preview Image -->
    <img id="inner_thumb_preview" src="#" class="w-16 my-2 hidden" alt="Inner Thumb Preview" />
</div>
