    ...
    <form method="POST" action="{{ route('our-team.update', $ourTeam->id) }}" enctype="multipart/form-data"
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div class="mt-4">
                ...
                <img src="{{ $ourTeam->profile }}" alt="profile" class="w-16 my-2">
            </div>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="speciality" class="block mt-1 w-full" type="text" name="speciality"
                    :value="old('speciality', $ourTeam->speciality)" placeholder="Enter speciality" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="experience" class="block mt-1 w-full" type="text" name="experience"
                    :value="old('experience', $ourTeam->experience)" placeholder="Enter experience" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="phone_no" class="block mt-1 w-full" type="text" name="phone_no" :value="old('phone_no', $ourTeam->phone_no)"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="trainers_skill" class="block mt-1 w-full" type="text" name="trainers_skill"
                    placeholder="Enter trainers skill" :value="old('trainers_skill', $ourTeam->trainers_skill)" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="facebook_url" class="block mt-1 w-full" type="text" name="facebook_url"
                    placeholder="Enter facebook url" :value="old('facebook_url', $ourTeam->facebook_url)" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="twitter_url" class="block mt-1 w-full" type="text" name="twitter_url"
                    placeholder="Enter twitter url" :value="old('twitter_url', $ourTeam->twitter_url)" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="google_url" class="block mt-1 w-full" type="text" name="google_url"
                    placeholder="Enter google url" :value="old('google_url', $ourTeam->google_url)" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="instagram_url" class="block mt-1 w-full" type="text" name="instagram_url"
                    placeholder="Enter instagram url" :value="old('instagram_url', $ourTeam->instagram_url)" />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="youtube_url" class="block mt-1 w-full" type="text" name="youtube_url"
                    placeholder="Enter youtube url" :value="old('youtube_url', $ourTeam->youtube_url)" />
