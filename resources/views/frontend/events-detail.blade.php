                            ...
                            <div class="register_mobile" style="display: none;">
                                ...
                                <div class="register_mobile_detail">
                                    <span class="date-and-time"><img loading="lazy"
                                            src="https://heal-satvicmovement-org.b-cdn.net/resources/img/rupee.png"
                                            alt="Rupee">Contribution: Rs: 990 - 2990</span>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 pe-3 pe-sm-3 mt-sm-0">
                                        <img loading="lazy" class="about_img w-100"
                                            src="https://heal-satvicmovement-org.b-cdn.net/resources/img/hosts/subah_1.webp"
                                            alt="subah">
                                        <h3 class="brown_heading mt-0 mt-sm-4 mb-3" id="subah"
                                            style="font-size: 30px !important;">Subah Saraf</h3>
                                        <p class="aboput_text">
                                            <span class="d-block">Subah is an <strong>acclaimed health educator</strong>,
                                                published author and co-founder of the health education platform 'Satvic
                                                Movement'. Subah's journey into health began after she <strong>healed her
                                                    own chronic diseases</strong> (thyroid imbalance, PCOD, major hairfall
                                                and acne) by following <strong>natural healing principles</strong>.</span>
                                            <span class="d-block mt-md-3 mt-3">At the young age of 17, she decided to
                                                devote her life to the purpose of uplifting people's health. She learnt the
                                                science of <strong>nature cure</strong> under the guidance of multiple
                                                Indian masters. She is also a <strong>certified health educator</strong>
                                                from the Hippocrates Health Institute, Florida. </span>
                                            <span class="d-block mt-md-3 mt-3">Subah's goal is to share this intricate
                                                healing knowledge with as many people as possible, so that we can move
                                                closer to a <strong>disease-free world</strong>.</span>
                                        </p>
                                    </div>
                                    <div class="col-lg-6 ps-3 ps-sm-3 pt-3 pt-sm-0">
                                        <img loading="lazy" class="about_img w-100 pt-4"
                                            src="https://heal-satvicmovement-org.b-cdn.net/resources/img/hosts/harsh_1.webp"
                                            alt="harsh">
                                        <h3 class="brown_heading mt-0 mt-sm-4 mb-3" id="harsh"
                                            style="font-size: 30px !important;">Harshvardhan Saraf</h3>
                                        <p class="aboput_text">
                                            <span class="d-block">Harshvardhan Saraf, a social entrepreneur and visionary,
                                                is the <strong>co-founder of Satvic Movement'</strong>. </span>
                                            <span class="d-block mt-md-3 mt-3">His journey began with his own personal
                                                health challenges. From a young age, Harshvardhan struggled with
                                                <strong>chronic sinusitis</strong> and <strong>skin problems</strong>, which
                                                affected his quality of life. Despite consulting renowned doctors in Mumbai
                                                and London, he found no relief and was even advised to undergo <strong>nose
                                                    surgery</strong>. However, at the age of 20, Harshvardhan made a pivotal
                                                decision to transform his <strong>food and lifestyle habits</strong>.
                                            </span>
                                            <span class="d-block mt-md-3 mt-3">To his amazement, these changes not only
                                                <strong>resolved his chronic health issues</strong> entirely but also made
                                                the need for surgery unnecessary. This profound transformation became a
                                                defining moment for him and ignited his purpose.</span>
                                            <span class="d-block mt-md-3 mt-3">Today, Harshvardhan is committed to creating
                                                a <strong>global movement</strong> where individuals can reclaim their
                                                health with nature's abundant healing resources.</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="register_form" class="register_form text-center">
                            ...
                            <div class="register_mobile_details">
                                <span class="date-and-time"><img loading="lazy"
                                        ...
                                        alt="Date" width="100" height="100" />20th Jan - 26th Jan everyday
                                </span>
                                ...
                                <span class="date-and-time"><img loading="lazy"
                                        ...
                                        alt="Date" width="100" height="100" />Contribution: Rs: 990 -
                                    2990</span>
                            </div>
                            ...
                            <div class="form_block">
                                <form id="reg_form" action="{{ route('customer.event.join') }}" method="post">
                                    ...
                                    <div class="pb-3">
                                        <div class="choose-your-amt pb-3 text-left"
                                            style="font-size: 16px !important;color: white">Select the amount you would
                                            like to contribute for this workshop. Your support helps us sustain Satvic
                                            Movement.</div>
                                        <div class="time_slot_table">
                                            <div class="time_slot_table_cell cell_one" style="width: 130px;">
                                                <input type="radio" name="reg_amount" id="amount_990"
                                                    class="radio-input d-none isvalid" value="990">
                                                <label for="amount_990" class="selecter">
                                                    <div class="am2">₹ 990</div>
                                                </label>
                                            </div>
                                            <div class="time_slot_table_cell cell_one" style="width: 130px;">
                                                <input type="radio" name="reg_amount" id="amount_1490"
                                                    class="radio-input d-none isvalid" value="1490">
                                                <label for="amount_1490" class="selecter">
                                                    <div class="am2">₹ 1490</div>
                                                </label>
                                            </div>
                                            <div class="time_slot_table_cell cell_one" style="width: 130px;">
                                                <input type="radio" name="reg_amount" id="amount_1990"
                                                    class="radio-input d-none isvalid" value="1990" checked>
                                                <label for="amount_1990" class="selecter">
                                                    <div class="am2">₹ 1990</div>
                                                </label>
                                            </div>
                                            <div class="time_slot_table_cell cell_one" style="width: 130px;">
                                                <input type="radio" name="reg_amount" id="amount_2990"
                                                    class="radio-input d-none isvalid" value="2990">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-12 mb-2 mb-sm-1">
                                            <div class="form-check radio-container checkbox-space">
                                                ...
                                                <div class="d-flex flex-row w-100" style="margin-left: 41px;">
                                                    ...
                                                    <label class="form-check-label ps-0" for="take_medicine_yes"> Yes
                                                    </label>
                                                    <input class="form-check-input" type="radio" value="no"
                                                        style="width: 27px;" name="take_medicine"
                                                        id="take_medicine_no">&nbsp;&nbsp;
                                                    <label class="form-check-label ps-0" for="take_medicine_no"> No
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-check radio-container checkbox-space">
                                                ...
                                                <div class="d-flex flex-row w-100" style="margin-left: 41px;">
                                                    <input class="form-check-input reason_check" type="checkbox"
                                                        ...
                                                        style="width: 15px;" name="reg-taking-medication[]">&nbsp;&nbsp;
                                                ...
                                                <div class="d-flex flex-row w-100" style="margin-left: 41px;">
                                                    <input class="form-check-input reason_check" type="checkbox"
                                                        value="Excess weight" id="Excess-weight" style="width: 15px;"
                                                ...
                                                <div class="d-flex flex-row w-100" style="margin-left: 41px;">
                                                    <input class="form-check-input reason_check" type="checkbox"
                                                        value="Skin problems" id="Skin-problems" style="width: 15px;"
                                                        name="reg-taking-medication[]">&nbsp;&nbsp;
                                                ...
                                                <div class="d-flex flex-row w-100" style="margin-left: 41px;">
                                                    <input class="form-check-input reason_check_other" type="checkbox"
                                                        value="Other" id="Other" style="width: 15px;"
                                                        name="reg-taking-medication[]">&nbsp;&nbsp;
                                                    <label class="form-check-label ps-0" for="Other">
                                                        Other
                                                    </label>
                                                </div>
                                                <input type="text" class="form-control d-none" name="other_reason"
                                                    id="other_reason">
                                        ...
                                        <div id="group-3" class="d-none waiver mt-0 mt-sm-3">
                                            <label id="waiver_message" class="mb-0 mb-sm-3 text-warning"> Important
                                                Note: For <strong id="checked_disease"></strong>, the Satvic healing plan
                                                could be helpful, but may not be sufficient on its own. This condition
                                                requires adjunct therapies and personalized guidance from a certified
                                                doctor, which we are unable to provide in an online platform like Satvic
                                                Movement.</label>
                                            <label id="waiver_message_2" class="mb-0 mb-sm-3 text-warning"> Important
                                                Note: For <strong id="checked_disease_2"></strong>, the Satvic healing
                                                plan could be helpful, but may not be sufficient on its own. These
                                                conditions require adjunct therapies and personalized guidance from a
                                                certified doctor, which we are unable to provide in an online platform like
                                                Satvic Movement.</label>
                                            <p><label><span
                                        ...
                                        <span class="waiver_check_span">
                                            <input type="checkbox" class="form-check-input"
                                                value="I confirm that I am not pregnant, breastfeeding, a child below age 14, or severely underweight."
                                                id="waiver_checkbox_reason">
                                            I confirm that I am not pregnant, breastfeeding, a child below age 14, or
                                        ...
                                        <span class="waiver_check_span">
                                            ...
                                            I agree and accept the <a
                                                href="https://heal.satvicmovement.org/terms_condition"
        ...
        function thankYouPageYoutubeVideoPlay(id, link) {
            ...
            if (id == 0) {
                $('#welcome_video_' + id).html(
                    '<iframe loading="lazy" width="100%" id="thankyou-mobile-videos" src="https://www.youtube.com/embed/' +
                    getYouTubeVideoId(link) +
                    '?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" style="border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;position: relative;top: 7px;height:' +
                    iframe_height + 'px;" allowfullscreen></iframe>');
            } else {
                $('#welcome_video_' + id).html('<iframe loading="lazy" width="100%" src="https://www.youtube.com/embed/' +
                    getYouTubeVideoId(link) +
                    '?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                );
            }
