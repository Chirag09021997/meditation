        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="total_view" class="block mt-1 w-full" type="number" name="total_view"
                    :value="old('total_view', $blog->total_view)" placeholder="Enter total view" step="0.01" min="0" />
            ...
            <div class="mt-4">
            <div class="flex items-center space-x-1">
                    <x-input-label for="thumb_image" :value="__('Thumb Image (540x382)')" />
                    <span class="text-red-500">*</span>
                </div>
                ...
                <img src="{{ $blog->thumb_image }}" alt="thumb upload" class="w-16 my-2">
            </div>
            ...
            <div class="mt-4">
                ...
                <select multiple id="categories" name="categories[]"
                    ...
                    <option disabled>Choose categories type</option>
                    @foreach ($categories as $category)
                        <option value="{{ $category->id }}" @selected(in_array($category->id, $oldCategoryList))>
