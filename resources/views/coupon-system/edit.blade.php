<x-app-layout>
    <x-head-lable>
        {{ __('Coupon System Edit') }}
    </x-head-lable>

    <form method="POST" action="{{ route('coupon-system.update', $couponSystem->id) }}" enctype="multipart/form-data"
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div class="mt-4">
                ...
                <select id="type" name="type"
                    ...
                    <option value="Percentage" @selected(old('type', $couponSystem->type) == 'Percentage')>Percentage</option>
                    <option value="Amount" @selected(old('type', $couponSystem->type) == 'Amount')>Amount</option>
                </select>
            </div>
