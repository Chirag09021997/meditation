    ...
    Multiselect.prototype = {
        defaults: {
            ...
            templates: {
                ...
                optionGroup:
                    '<div class="multiselect-item multiselect-group dropdown-item-text"></div>',
                resetButton:
        ...
        buildDropdownOptions: function () {
                    ...
                    if (event.shiftKey && this.options.multiple) {
                        ...
                        if (
                            ...
                            var range = this.$popupContainer
                                .find(
                                    ".multiselect-item:not(.multiselect-filter-hidden)"
                                )
                                .slice(from, to)
                                .find("input");
            ...
            this.$container.off("keydown.multiselect").on(
                ...
                $.proxy(function (event) {
                    if (
                        $("input.multiselect-search", this.$container).is(
                            ":focus"
                        )
                    ) {
                        return;
        ...
        refresh: function () {
            var inputs = {};
            $(".multiselect-item input", this.$popupContainer).each(
                function () {
